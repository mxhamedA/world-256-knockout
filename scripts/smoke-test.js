...
const retro2010SquadsSource = fs.readFileSync(path.join(root, "data/retro/2010/squads.js"), "utf8");
const retro2014SquadsSource = fs.readFileSync(path.join(root, "data/retro/2014/squads.js"), "utf8");
const retro2018SquadsSource = fs.readFileSync(path.join(root, "data/retro/2018/squads.js"), "utf8");
const retro2022SquadsSource = fs.readFileSync(path.join(root, "data/retro/2022/squads.js"), "utf8");
const retro2022ScheduleSource = fs.readFileSync(path.join(root, "data/retro/2022/schedule.js"), "utf8");
