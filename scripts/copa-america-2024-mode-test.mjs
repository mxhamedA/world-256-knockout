...
assert.match(app, /RETRO_COPA_2024_PLAYABLE = true/);
assert.match(app, /Number\(year\) === 2024[\s\S]*COPA AMÉRICA USA 2024/);
...
assert.match(index, /Copa América 2024 is here/);
assert.match(index, /Play Copa América 2024/);
...
assert.match(copaSourceCss, /Copa América 2024 final UI lock/);
assert.match(copaSourceCss, /retro-copa-2024-active #mainContent \.bracket-fixture\[data-connects="true"\]::after/);
assert.match(copaSourceCss, /retro-copa-2024-active :is\(\.confirm-modal, \.snapshot-modal\)/);
