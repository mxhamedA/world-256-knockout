...
assert.equal((html.match(/data-open-tournament-theme/g) || []).length, 0, "Custom builders should not expose match themes.");
...
assert.match(app, /match UI applied to supported tournament modes/, "Theme changes should confirm their match-screen scope.");
